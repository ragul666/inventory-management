...
const CreateMedicine = () => {
  ...
  const baseShopURL = "http://localhost:3005/api/v1/orders/placeOrder";
  const medicinesURL = "http://localhost:3005/api/v1/shop/getMedicineFromShop";
  ...
  const handleSubmit = (event) => {
    ...
    let medicineId = selectedMedicine.medicineId;
    let medicineName = selectedMedicine.medicineName;
    ...
    axios
      .post(godownId ? baseURL : baseShopURL, medicineData, config)
      .then((response) => {
  ...
  function selectMedicine(event) {
    setSelectedMedicine(
      medicinesList.find((medicine) => {
        return medicine.medicineId == event.target.value;
      })
    );
        ...
        >
          ...
          >
            ...
            <TextField
              ...
              id="company"
              name="company"
              value={selectedMedicine ? selectedMedicine.medicineCompany : ""}
            />
            {/* <p style={{ marginTop: "4px", marginBottom: "-8px" }}>
              Medicine Type
            </p>
